...
var wasmBinaryFile = 'CH02_HelloTriangle.wasm';
...
var asmGlobalArg = {};
var asmLibraryArg = { "XChangeWindowAttributes": _XChangeWindowAttributes, "XCreateWindow": _XCreateWindow, "XInternAtom": _XInternAtom, "XMapWindow": _XMapWindow, "XOpenDisplay": _XOpenDisplay, "XSendEvent": _XSendEvent, "XSetWMHints": _XSetWMHints, "XStoreName": _XStoreName, "__lock": ___lock, "__unlock": ___unlock, "eglChooseConfig": _eglChooseConfig, "eglCreateContext": _eglCreateContext, "eglCreateWindowSurface": _eglCreateWindowSurface, "eglGetConfigs": _eglGetConfigs, "eglGetDisplay": _eglGetDisplay, "eglInitialize": _eglInitialize, "eglMakeCurrent": _eglMakeCurrent, "eglSwapBuffers": _eglSwapBuffers, "emscripten_get_sbrk_ptr": _emscripten_get_sbrk_ptr, "emscripten_memcpy_big": _emscripten_memcpy_big, "emscripten_resize_heap": _emscripten_resize_heap, "fd_write": _fd_write, "gettimeofday": _gettimeofday, "glAttachShader": _glAttachShader, "glBindAttribLocation": _glBindAttribLocation, "glBindBuffer": _glBindBuffer, "glBufferData": _glBufferData, "glClear": _glClear, "glClearColor": _glClearColor, "glCompileShader": _glCompileShader, "glCreateProgram": _glCreateProgram, "glCreateShader": _glCreateShader, "glDeleteProgram": _glDeleteProgram, "glDeleteShader": _glDeleteShader, "glDrawArrays": _glDrawArrays, "glEnableVertexAttribArray": _glEnableVertexAttribArray, "glGenBuffers": _glGenBuffers, "glGetProgramInfoLog": _glGetProgramInfoLog, "glGetProgramiv": _glGetProgramiv, "glGetShaderInfoLog": _glGetShaderInfoLog, "glGetShaderiv": _glGetShaderiv, "glLinkProgram": _glLinkProgram, "glShaderSource": _glShaderSource, "glUseProgram": _glUseProgram, "glVertexAttribPointer": _glVertexAttribPointer, "glViewport": _glViewport, "memory": wasmMemory, "setTempRet0": _setTempRet0, "table": wasmTable };
var asm = createWasm();
